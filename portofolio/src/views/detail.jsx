...
export default function Detail() {
  ...
  const { id } = useParams()
  const detail = data.find((el) => {
    if (id == el.id) {
      return el
    }
  })
      const features = detail.usage.map((el) => {
        return {
            name: el.name,
            description: 'I m using this cool framework/libraries',
            icon: (
  ...
  return (
      <>
          <Navbar />
          <Hero />
          <div className="bg-white py-24 pb-10">
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                  <div className="mx-auto max-w-2xl lg:text-center">
                      ...
                      <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                          My Project Detail Here
                      </p>
                      <p className="mt-6 text-lg leading-8 text-gray-600">
                          {detail.description}
                      </p>
                  </div>
                  <div className="mx-auto mt-10 max-w-1xl sm:mt-20 lg:mt-24 lg:max-w-2xl">
          ...
          <div className="bg-white py-24 sm:py-32">
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                  <div className="mx-auto max-w-2xl sm:text-center">
                      ...
                      <p className="mt-6 text-lg leading-8 text-gray-600">
                          There are my screenshot for more detail in my project 
                      </p>
                  </div>
            {detail.addImg.map((el) => {
              return (
